...
export const sidebarConfig: SidebarItem[] = [
  { type: 'link', label: 'Quickstart', href: '/' },
  { type: 'divider' },
  {
    type: 'group', label: 'Admin', defaultOpen: true, items: [
      { type: 'link', label: 'Overview', href: '/admin' },
      {
        type: 'group', label: 'Authentication', defaultOpen: false, items: [
          ...
          { type: 'link', label: 'Reset Password', href: '/admin/auth/reset-password', method: 'POST' },
        ],
      },
      {
        type: 'group', label: 'Users', defaultOpen: false, items: [
          ...
          { type: 'link', label: 'Summary & Activities', href: '/admin/users/activities', method: 'GET' },
          { type: 'link', label: 'Locations', href: '/admin/locations', method: 'GET' },
        ],
      },
      {
        type: 'group', label: 'Admin Users', defaultOpen: false, items: [
          { type: 'link', label: 'List Admin Users', href: '/admin/admin-users/list', method: 'GET' },
          { type: 'link', label: 'Get Admin User', href: '/admin/admin-users/get', method: 'GET' },
          { type: 'link', label: 'Create Admin User', href: '/admin/admin-users/create', method: 'POST' },
          { type: 'link', label: 'Update Admin User', href: '/admin/admin-users/update', method: 'POST' },
          { type: 'link', label: 'Disable / Enable / Delete', href: '/admin/admin-users/manage', method: 'POST' },
          { type: 'link', label: 'Profile', href: '/admin/profile', method: 'GET' },
        ],
      },
      {
        type: 'group', label: 'Providers', defaultOpen: false, items: [
          ...
          { type: 'link', label: 'Summary & Activities', href: '/admin/providers/activities', method: 'GET' },
          { type: 'link', label: 'Status History', href: '/admin/providers/status-history', method: 'GET' },
          { type: 'link', label: 'Extras', href: '/admin/providers/extras', method: 'GET' },
        ],
      },
      {
      ...
      {
        type: 'group', label: 'Requests', defaultOpen: false, items: [
      ...
      {
        type: 'group', label: 'Payments', defaultOpen: false, items: [
      ...
      {
        type: 'group', label: 'Transactions', defaultOpen: false, items: [
      ...
      {
        type: 'group', label: 'Statements', defaultOpen: false, items: [
      ...
      {
        type: 'group', label: 'Notifications', defaultOpen: false, items: [
      ...
      {
        type: 'group', label: 'Service Types', defaultOpen: false, items: [
